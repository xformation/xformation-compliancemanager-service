...
jest.mock('util/AppConfig', () => ({
  xfcomplianceAppPathPrefix: jest.fn(() => ''),
  xfcomplianceServerUrl: jest.fn(() => undefined),
...
describe('Navigation', () => {
  ...
  describe('renders custom navigation elements supplied by plugins', () => {
    ...
    beforeEach(() => {
      AppConfig.xfcomplianceAppPathPrefix = jest.fn(() => '');
    ...
    it('prefix plugin navigation item paths with app prefix', () => {
      AppConfig.xfcomplianceAppPathPrefix.mockReturnValue('/my/crazy/prefix');
      const wrapper = mount(<SimpleNavigation component={Navigation} />);
