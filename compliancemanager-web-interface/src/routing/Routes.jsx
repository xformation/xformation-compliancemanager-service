...
const defaultExport = AppConfig.xfcomplianceAppPathPrefix() ? qualifyUrls(Routes, AppConfig.xfcomplianceAppPathPrefix()) : Routes;
...
defaultExport.pluginRoute = (routeKey, throwError = true) => {
  ...
  const route = (AppConfig.xfcomplianceAppPathPrefix() ? qualifyUrls(pluginRoutes, AppConfig.xfcomplianceAppPathPrefix()) : pluginRoutes)[routeKey];
