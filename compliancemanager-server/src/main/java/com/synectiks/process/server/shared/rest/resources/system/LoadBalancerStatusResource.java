...
public class LoadBalancerStatusResource extends RestResource {
    ...
    @ApiOperation(value = "Get status of this compliancemanager server node for load balancers. " +
    ...
    @ApiOperation(value = "Override load balancer status of this compliancemanager server node. Next lifecycle " +
